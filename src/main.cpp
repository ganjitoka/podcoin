...
uint256 hashGenesisBlock("0x000000001ec22dfdb7ecfab78fa789791bc0562eb337a350da60ad5b905ca2e2");
...
const string strMessageMagic = "PODCOIN Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000001ec22dfdb7ecfab78fa789791bc0562eb337a350da60ad5b905ca2e2");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-07T11:29:42; last:700.00 buy:700.00 sell:700.87";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391772596;
        block.nBits    = 486604799;
        block.nNonce   = 571924025;
        ...
        assert(block.hashMerkleRoot == uint256("0x3088e84acf859e19ec910ca2441222dd57ed4a3bcd2eb1d32167577da1b7ea2c"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PODCOINMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PODCOINMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running PODCOINMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PODCOINMiner terminated\n");
        throw;
    }
}
